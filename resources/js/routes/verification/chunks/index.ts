...
/**
* @see \App\Http\Controllers\EvidenceVerificationComparisonController::complete
* @see app/Http/Controllers/EvidenceVerificationComparisonController.php:155
* @route '/verify/{evidence}/complete'
*/
export const complete = (args: { evidence: string | { evidence_number: string } } | [evidence: string | { evidence_number: string } ] | string | { evidence_number: string }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/verify/{evidence}/complete'
*/
complete.post = (args: { evidence: string | { evidence_number: string } } | [evidence: string | { evidence_number: string } ] | string | { evidence_number: string }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: complete.url(args, options),
    method: 'post',
})
